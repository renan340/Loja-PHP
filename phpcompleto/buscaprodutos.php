         ...
         <div class="row-fluid">
          <ul class="pagination justify-content-center">
            <li class="page-item">
              ...
              <a class="page-link" href="buscaprodutos.php?pagina=<?php echo $pagina_anterior; ?>" aria-label="Previous">
              ...
              <?php }  ?>
              	...
              	<?php 
					...
					for($i = 1; $i < $num_pagina + 1; $i++){ ?>
						<li class="page-item"><a class="page-link" href="buscaprodutos.php?pagina=<?php echo $i; ?>"><?php echo $i; ?></a></li>
				<?php } ?>
              
              <?php
if($pagina_posterior <= $num_pagina){ ?>
              <li class="page-item">  
              <a class="page-link" href="buscaprodutos.php?pagina=<?php echo $pagina_posterior; ?>" aria-label="Next">
